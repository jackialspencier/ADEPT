...
# Lazy-import RL stages: newer trl removed trl.core.PPODecorators, and ADEPT SFT
# must not fail at import time because PPO trainer still references the old API.
